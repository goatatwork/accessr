...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post slots_url, params: { slot: { description: @slot.description, name: @slot.name, references: @slot.references, slot_number: @slot.slot_number } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { description: @slot.description, name: @slot.name, references: @slot.references, slot_number: @slot.slot_number } }
